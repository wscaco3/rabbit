 ...
 */
package com.rabbit.jfinal.ext.render.excel;
...
public class PoiRender extends Render {
    ...
    public void render() {
        ...
        String nfm;
		try {
			nfm = new String(fileName.getBytes(getEncoding()),"ISO-8859-1");
		} catch (UnsupportedEncodingException e1) {
			nfm = fileName;
		}
        response.setHeader("Content-disposition", "attachment; filename=" + nfm);
