...
//		Session session = Session.getDefaultInstance(props, null);
	 ...
	 */
 	public static void main(String[] args) {
 		...
 		sendmail.setUserName("info@weiqichinese.com");
 		sendmail.setPassWord("weiqi123"); 		
 		sendmail.setFrom("info@weiqichinese.com");
 		sendmail.setTo("93933074@qq.com");
 		sendmail.setSubject("你好，这是测试！");
 		sendmail.setContent("你好这是一个带附件的测试！");
		sendmail.attachfile("d:\\张三的信.xlsx");
